...
export async function main(ns: NS) {
    ...
    switch (flags.command) {
        ...
        case command.autosolve: {
            ...
            findAndFilterContracts(ns, flags.filters).forEach((contract) => autosolve(ns, contract));
            break;
        }
...
export function findAndFilterContracts(ns: NS, filters: Filters = {}) {
...
export function autosolve(ns: NS, contract: Contract) {
